...
public class RedisUtils {
     ...
     */
    public String getSet(String key, String value, int indexdb) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
     ...
     */
    public Long setrange(String key, String str, int offset, int indexdb) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
     ...
     * @return 失败返回null
     */
    public Long serlen(String key, int indexdb) {
        Jedis jedis = null;
        Long res = null;
        try {
            jedis = jedisPool.getResource();
     ...
     * @return
     */
    public Long hincrby(String key, String field, Long value, int indexdb) {
        Jedis jedis = null;
        Long res = null;
        try {
            jedis = jedisPool.getResource();
     ...
     * @return
     */
    public Boolean hexists(String key, String field, int indexdb) {
        Jedis jedis = null;
        Boolean res = false;
        try {
            jedis = jedisPool.getResource();
     ...
     * @return
     */
    public Long hlen(String key, int indexdb) {
        Jedis jedis = null;
        Long res = null;
        try {
            jedis = jedisPool.getResource();
    ...
    /**
     * <p>
     * 通过key从对应的list中删除指定的count个 和 参数value相等的元素
     * </p>
     *
     * @param key
     ...
     * @return 返回列表形式的排序结果
     */
    public List<String> sort(String key, SortingParams sortingParameters, int indexdb) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
     ...
     * @return 返回列表形式的排序结果
     */
    public List<String> sort(String key, int indexdb) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
     ...
     * @return
     */
    public String spop(String key, int indexdb) {
        Jedis jedis = null;
        String res = null;
        try {
            jedis = jedisPool.getResource();
    ...
    public void pfadd(int indexdb, String key, String values) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
     ...
     * 管道
     * */
    public Pipeline getPipeline(int indexdb) {
        Jedis jedis = null;
     ...
     * 位图
     * */
    public List<Long> getBitField(String key, String method, String type, String beginindex) {
        Jedis jedis = null;
        List<Long> bitfield = null;
        try {
            jedis = jedisPool.getResource();
            bitfield = jedis.bitfield(key, method, type, beginindex);
        } catch (Exception e) {
            log.info("获取位图失败");
        }
        return bitfield;
